...
func nodoTestCommand(_ executable:String,_ args:[String]) throws -> (Int32,String)? {
 ...
 let labels=["com.nodo-optional.dsh-watchdog","com.nodo-optional.vk-factoscope"]
 let label=labels.first{args.contains(domain+"/"+$0)||args.contains(root.appendingPathComponent("Library/LaunchAgents/"+$0+".plist").path)} ?? "com.nodo-optional.dsh-watchdog"
 ...
 let state=root.appendingPathComponent(label=="com.nodo-optional.dsh-watchdog" ? "mock-watchdog.json":"mock-factoscope.json"),log=root.appendingPathComponent("mock-watchdog-calls.jsonl")
 ...
 if args[0]=="print-disabled"{return (0,"com.nodo-optional.dsh-watchdog => false\ncom.nodo-optional.vk-factoscope => false\n")}

...
fs.writeFileSync(path.join(out,'Contents/Info.plist'),`<?xml version="1.0" encoding="UTF-8"?><plist version="1.0"><dict><key>CFBundleExecutable</key><string>NODORescue</string><key>CFBundleIdentifier</key><string>local.nodo.rescue</string><key>CFBundleName</key><string>NODO Rescue</string><key>CFBundleIconFile</key><string>NODO.icns</string><key>CFBundleShortVersionString</key><string>${version}</string><key>CFBundleVersion</key><string>${version}</string><key>NSHighResolutionCapable</key><true/></dict></plist>`);

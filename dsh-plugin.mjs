...
export const inject=['sessionController','workspaceController','typertGateway','tools','agents','sessions','attachments','fileUploads'];
export function apply(ctx){
 ...
 const remote=require('./lib/remote-controller.cjs').createRemoteController(ctx,lifecycle);
 ...
 ctx.on('dispose',()=>{remote.dispose();lifecycle.dispose();disposeGuard();server.close();});
}
